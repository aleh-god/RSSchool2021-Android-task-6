...
class MainFragment : Fragment(), SurfaceHolder.Callback, SeekBar.OnSeekBarChangeListener,
...
//          setDataSource(URL)
    ...
    fun loadMedia(data: Intent?) {
        selectedVideoUri = data?.data!!
        binding.videoView.holder.addCallback(this) // Invoke surfaceCreated() by calling video_view.holder.addCallback(this).
    }
